    ...
    trpc.post.deletePost.mutationOptions({
      onSuccess: async () =>
        await queryClient.invalidateQueries(
          trpc.post.getPostsByUsername.infiniteQueryFilter({
            username: session?.user.username ?? undefined,
          }),
        ),
    }),
  );
  function deletePostToast() {
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={() => setIsDialogOpen(true)}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction onClick={deletePostToast} variant="destructive">
            Delete
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
